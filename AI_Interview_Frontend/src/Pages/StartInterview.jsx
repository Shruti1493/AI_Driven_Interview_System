...
const StartInterview = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen">
            ...
            <div className="flex flex-col items-center justify-self-auto min-h-screen bg-gray-100 p-4 gap-4">
                {!question && (
                    <div>
                        <div className="bg-white shadow-lg rounded-lg p-6 max-w-xl w-full">
                            ...
                            <ul className="list-disc text-gray-700 mb-6 ml-4">
                                ...
                                <li className="mb-2">
                                    Prepare your resume and any other relevant
                                    documents.
                                </li>
                                <li className="mb-2">
                                ...
                                <li className="mb-2">
                                    Once the interview starts, you cannot pause
                                    it.
                                </li>
                                <li>
                                    Your performance will be reviewed at the end
